...
const std::array<Terminfo::Capability, Terminfo::Capabilities::m_booleans_size>
    Terminfo::Capabilities::m_booleans{
        // Booleans
        Capability{Boolean::auto_left_margin, "bw",
                   "cub1 wraps from column 0 to last column"},
        Capability{Boolean::auto_right_margin, "am",
                   "terminal has automatic margins"},
        Capability{Boolean::no_esc_ctlc, "xsb",
                   "beehive (f1=escape, f2=ctrl C)"},
        Capability{Boolean::ceol_standout_glitch, "xhp",
                   "standout not erased by overwriting (hp)"},
        Capability{Boolean::eat_newline_glitch, "xenl",
                   "newline ignored after 80 cols (concept)"},
        Capability{Boolean::erase_overstrike, "eo",
                   "can erase overstrikes with a blank"},
        Capability{Boolean::generic_type, "gn", "generic line type"},
        Capability{Boolean::hard_copy, "hc", "hardcopy terminal"},
        Capability{Boolean::has_meta_key, "km",
                   "Has a meta key (i.e., sets 8th-bit)"},
        Capability{Boolean::has_status_line, "hs", "has extra status line"},
        Capability{Boolean::insert_null_glitch, "in",
                   "insert mode distinguishes nulls"},
        Capability{Boolean::memory_above, "da",
                   "display may be retained above the screen"},
        Capability{Boolean::memory_below, "db",
                   "display may be retained below the screen"},
        Capability{Boolean::move_insert_mode, "mir",
                   "safe to move while in insert mode"},
        Capability{Boolean::move_standout_mode, "msgr",
                   "safe to move while in standout mode"},
        Capability{Boolean::over_strike, "os", "terminal can overstrike"},
        Capability{Boolean::status_line_esc_ok, "eslok",
                   "escape can be used on the status line"},
        Capability{Boolean::dest_tabs_magic_smso, "xt",
                   "tabs destructive, magic so char (t1061)"},
        Capability{Boolean::tilde_glitch, "hz", "cannot print ~'s (Hazeltine)"},
        Capability{Boolean::transparent_underline, "ul",
                   "underline character overstrikes"},
        Capability{Boolean::xon_xoff, "xon",
                   "terminal uses xon/xoff handshaking"},
        Capability{Boolean::needs_xon_xoff, "nxon",
                   "padding will not work, xon/xoff required"},
        Capability{Boolean::prtr_silent, "mc5i",
                   "printer will not echo on screen"},
        Capability{Boolean::hard_cursor, "chts", "cursor is hard to see"},
        Capability{Boolean::non_rev_rmcup, "nrrmc",
                   "smcup does not reverse rmcup"},
        Capability{Boolean::no_pad_char, "npc", "pad character does not exist"},
        Capability{Boolean::non_dest_scroll_region, "ndscr",
                   "scrolling region is non-destructive"},
        Capability{Boolean::can_change, "ccc",
                   "terminal can re-define existing colors"},
        Capability{Boolean::back_color_erase, "bce",
                   "screen erased with background color"},
        Capability{Boolean::hue_lightness_saturation, "hls",
                   "terminal uses only HLS color notation (Tektronix)"},
        Capability{Boolean::col_addr_glitch, "xhpa",
                   "only positive motion for hpa/mhpa caps"},
        Capability{Boolean::cr_cancels_micro_mode, "crxm",
                   "using cr turns off micro mode"},
        Capability{Boolean::has_print_wheel, "daisy",
                   "printer needs operator to change character set"},
        Capability{Boolean::row_addr_glitch, "xvpa",
                   "only positive motion for vpa/mvpa caps"},
        Capability{Boolean::semi_auto_right_margin, "sam",
                   "printing in last column causes cr"},
        Capability{Boolean::cpi_changes_res, "cpix",
                   "changing character pitch changes resolution"},
        Capability{Boolean::lpi_changes_res, "lpix",
                   "changing line pitch changes resolution"},
    };

const std::array<Terminfo::Capability, Terminfo::Capabilities::m_intergers_size>
    Terminfo::Capabilities::m_integers{
        // Integers
        Capability{Integer::columns, "cols", "number of columns in a line"},
        Capability{Integer::init_tabs, "it", "tabs initially every # spaces"},
        Capability{Integer::lines, "lines",
                   "number of lines on screen or page"},
        Capability{Integer::lines_of_memory, "lm",
                   "lines of memory if > line. 0 means varies"},
        Capability{Integer::magic_cookie_glitch, "xmc",
                   "number of blank characters left by smso or rmso"},
        Capability{Integer::padding_baud_rate, "pb",
                   "lowest baud rate where padding needed"},
        Capability{Integer::virtual_terminal, "vt",
                   "virtual terminal number (CB/unix)"},
        Capability{Integer::width_status_line, "wsl",
        ...
        Capability{Integer::max_attributes, "ma",
                   "maximum combined attributes terminal can handle"},
        Capability{Integer::maximum_windows, "wnum",
                   "maximum number of definable windows"},
        Capability{Integer::max_colors, "colors",
                   "maximum number of colors on screen"},
        Capability{Integer::max_pairs, "pairs",
                   "maximum number of color-pairs on the screen"},
        Capability{Integer::no_color_video, "ncv",
                   "video attributes that cannot be used with colors"},
        Capability{Integer::buffer_capacity, "bufsz",
                   "numbers of bytes buffered before printing"},
        Capability{Integer::dot_vert_spacing, "spinv",
                   "spacing of pins vertically in pins per inch"},
        Capability{Integer::dot_horz_spacing, "spinh",
                   "spacing of dots horizontally in dots per inch"},
        Capability{Integer::max_micro_address, "maddr",
                   "maximum value in micro_..._address"},
        Capability{Integer::max_micro_jump, "mjump",
                   "maximum value in parm_..._micro"},
        Capability{Integer::micro_col_size, "mcs",
                   "character step size when in micro mode"},
        Capability{Integer::micro_line_size, "mls",
                   "line step size when in micro mode"},
        Capability{Integer::number_of_pins, "npins",
                   "numbers of pins in print-head"},
        Capability{Integer::output_res_char, "orc",
                   "horizontal resolution in units per line"},
        Capability{Integer::output_res_line, "orl",
                   "vertical resolution in units per line"},
        Capability{Integer::output_res_horz_inch, "orhi",
                   "horizontal resolution in units per inch"},
        Capability{Integer::output_res_vert_inch, "orvi",
                   "vertical resolution in units per inch"},
        Capability{Integer::print_rate, "cps",
                   "print rate in characters per second"},
        Capability{Integer::wide_char_size, "widcs",
                   "character step size when in double wide mode"},
        Capability{Integer::buttons, "btns", "number of buttons on mouse"},
        Capability{Integer::bit_image_entwining, "bitwin",
                   "number of passes for each bit-image row"},
        Capability{Integer::bit_image_type, "bitype",
                   "type of bit-image device"},
    };

const std::array<Terminfo::Capability, Terminfo::Capabilities::m_strings_size>
    Terminfo::Capabilities::m_strings = {
        // Strings
        ...
        Capability{String::column_address, "hpa",
                   "horizontal position #1, absolute (P)"},
        Capability{String::command_character, "cmdch",
        ...
        Capability{
            String::cursor_mem_address, "mrcup",
            "memory relative cursor addressing, move to row #1 columns #2"},
        Capability{String::cursor_normal, "cnorm",
                   "make cursor appear normal (undo civis/cvvis)"},
        Capability{String::cursor_right, "cuf1",
                   "non-destructive space (move right one space)"},
        Capability{String::cursor_to_ll, "ll",
        ...
        Capability{String::enter_alt_charset_mode, "smacs",
                   "start alternate character set (P)"},
        Capability{String::enter_blink_mode, "blink", "turn on blinking"},
        Capability{String::enter_bold_mode, "bold",
                   "turn on bold (extra bright) mode"},
        Capability{String::enter_ca_mode, "smcup",
        ...
        Capability{String::enter_secure_mode, "invis",
                   "turn on blank mode (characters invisible)"},
        Capability{String::enter_protected_mode, "prot",
                   "turn on protected mode"},
        Capability{String::enter_reverse_mode, "rev",
                   "turn on reverse video mode"},
        Capability{String::enter_standout_mode, "smso", "begin standout mode"},
        Capability{String::enter_underline_mode, "smul",
                   "begin underline mode"},
        Capability{String::erase_chars, "ech", "erase #1 characters (P)"},
        Capability{String::exit_alt_charset_mode, "rmacs",
                   "end alternate character set (P)"},
        Capability{String::exit_attribute_mode, "sgr0",
                   "turn off all attributes"},
        Capability{String::exit_ca_mode, "rmcup",
        ...
        Capability{String::flash_screen, "flash",
                   "visible bell (may not move cursor)"},
        Capability{String::form_feed, "ff",
        ...
        Capability{String::insert_padding, "ip",
        ...
        Capability{String::key_eic, "krmir",
        ...
        Capability{String::keypad_local, "rmkx",
        ...
        Capability{String::lab_f10, "lf10",
        ...
        Capability{String::parm_left_cursor, "cub",
                   "move #1 characters to the left (P)"},
        Capability{String::parm_right_cursor, "cuf",
        ...
        Capability{String::pkey_key, "pfkey",
                   "program function key #1 to type string #2"},
        Capability{String::pkey_local, "pfloc",
                   "program function key #1 to execute string #2"},
        Capability{String::pkey_xmit, "pfx",
        ...
        Capability{String::restore_cursor, "rc",
                   "restore cursor to position of last save_cursor"},
        Capability{String::row_address, "vpa",
                   "vertical position #1 absolute (P)"},
        Capability{String::save_cursor, "sc",
        ...
        Capability{String::char_padding, "rmp",
                   "like ip but when in insert mode"},
        Capability{String::acs_chars, "acsc",
                   "graphics charset pairs, based on vt100"},
        Capability{String::plab_norm, "pln",
                   "program label #1 to show string #2"},
        Capability{String::key_btab, "kcbt", "back-tab key"},
        Capability{String::enter_xon_mode, "smxon",
                   "turn on xon/xoff handshaking"},
        Capability{String::exit_xon_mode, "rmxon",
        ...
        Capability{String::key_seol, "kEOL",
        ...
        Capability{String::req_for_input, "rfi",
        ...
        Capability{String::create_window, "cwin",
        ...
        Capability{String::quick_dial, "qdial",
        ...
        Capability{String::orig_pair, "op",
                   "Set default pair to its original value"},
        Capability{String::orig_colors, "oc",
                   "Set all color pairs to the original ones"},
        Capability{String::initialize_color, "initc",
                   "initialize color #1 to (#2,#3,#4)"},
        Capability{String::initialize_pair, "initp",
                   "Initialize color pair #1 to fg=(#2,#3,#4), bg=(#5,#6,#7)"},
        Capability{String::set_color_pair, "scp",
        ...
        Capability{String::change_char_pitch, "cpi",
                   "Change number of characters per inch to #1"},
        Capability{String::change_line_pitch, "lpi",
                   "Change number of lines per inch to #1"},
        Capability{String::change_res_horz, "chr",
                   "Change horizontal resolution to #1"},
        Capability{String::change_res_vert, "cvr",
                   "Change vertical resolution to #1"},
        Capability{String::define_char, "defc",
                   "Define a character #1, #2 dots wide, descender #3"},
        Capability{String::enter_doublewide_mode, "swidm",
                   "Enter double-wide mode"},
        Capability{String::enter_draft_quality, "sdrfq",
                   "Enter draft-quality mode"},
        Capability{String::enter_italics_mode, "sitm", "Enter italic mode"},
        Capability{String::enter_leftward_mode, "slm",
                   "Start leftward carriage motion"},
        Capability{String::enter_micro_mode, "smicm",
                   "Start micro-motion mode"},
        Capability{String::enter_near_letter_quality, "snlq", "Enter NLQ mode"},
        Capability{String::enter_normal_quality, "snrmq",
                   "Enter normal-quality mode"},
        Capability{String::enter_shadow_mode, "sshm",
                   "Enter shadow-print mode"},
        Capability{String::enter_subscript_mode, "ssubm",
                   "Enter subscript mode"},
        Capability{String::enter_superscript_mode, "ssupm",
                   "Enter superscript mode"},
        Capability{String::enter_upward_mode, "sum",
                   "Start upward carriage motion"},
        Capability{String::exit_doublewide_mode, "rwidm",
        ...
        Capability{String::set_lr_margin, "smglr",
                   ...
                   "BSD termcap)."},
        Capability{String::set_tb_margin, "smgtb",
                   "Sets both top and bottom margins to #1, #2"},
        Capability{String::bit_image_repeat, "birep",
                   "Repeat bit image cell #1 #2 times"},
        Capability{String::bit_image_newline, "binel",
                   "Move to next row of the bit image"},
        Capability{String::bit_image_carriage_return, "bicr",
                   "Move to beginning of same row"},
        Capability{String::color_names, "colornm", "Give name for color #1"},
        Capability{String::define_bit_image_region, "defbi",
                   "Define rectangular bit image region"},
        Capability{String::end_bit_image_region, "endbi",
                   "End a bit-image region"},
        Capability{String::set_color_band, "setcolor",
                   "Change to ribbon color #1"},
        Capability{String::set_page_length, "slines",
                   "Set page length to #1 lines"},
        Capability{String::display_pc_char, "dispc", "Display PC character #1"},
        Capability{String::enter_pc_charset_mode, "smpch",
                   "Enter PC character display mode"},
        Capability{String::exit_pc_charset_mode, "rmpch",
                   "Exit PC character display mode"},
        Capability{String::enter_scancode_mode, "smsc",
        ...
        Capability{String::scancode_escape, "scesc",
                   "Escape for scancode emulation"},
        Capability{String::alt_scancode_esc, "scesa",
                   "Alternate escape for scancode emulation"},
        Capability{String::enter_horizontal_hl_mode, "ehhlm",
                   "Enter horizontal highlight mode"},
        Capability{String::enter_left_hl_mode, "elhlm",
                   "Enter left highlight mode"},
        Capability{String::enter_low_hl_mode, "elohlm",
                   "Enter low highlight mode"},
        Capability{String::enter_right_hl_mode, "erhlm",
                   "Enter right highlight mode"},
        Capability{String::enter_top_hl_mode, "ethlm",
                   "Enter top highlight mode"},
        Capability{String::enter_vertical_hl_mode, "evhlm",
                   "Enter vertical highlight mode"},
        Capability{String::set_a_attributes, "sgr1",
        ...
        // Others
        Capability{String::set_underline_color, "setal",
                   "set (under)line color"},
        Capability{String::lock_memory_above_cursor, "meml",
                   "locks memory above the cursor (ala HP terminals)"},
        Capability{String::unlock_memory_above_cursor, "memu",
                   "unlocks memory above the cursor (ala HP terminals)"},
        Capability{String::enable_real_bold, "gsbom",
                   " enable real bold (not intensity bright) mode"},
        Capability{String::disable_real_bold, "grbom",
                   "disable real bold (not intensity bright) mode"},
        Capability{String::mouse_response, "xm",
                   "describes the mouse response"},
        ...
        Capability{String::modify_selection_clipboard, "Ms",
                   "modifies the selection/clipboard"},
};

Terminfo::Boolean Terminfo::Capabilities::getBoolean(const std::string &str) {
  const Terminfo::Capability *found =
      std::find(m_booleans.begin(), m_booleans.end(), str);
  if (found != m_booleans.end())
    return static_cast<Terminfo::Boolean>(found->value());
  throw std::out_of_range(str);
}

Terminfo::Integer Terminfo::Capabilities::getInteger(const std::string &str) {
  const Terminfo::Capability *found =
      std::find(m_integers.begin(), m_integers.end(), str);
  if (found != m_integers.end())
    return static_cast<Terminfo::Integer>(found->value());
  throw std::out_of_range(str);
}

Terminfo::String Terminfo::Capabilities::getString(const std::string &str) {
  const Terminfo::Capability *found =
      std::find(m_strings.begin(), m_strings.end(), str);
  if (found != m_strings.end())
    return static_cast<Terminfo::String>(found->value());
  throw std::out_of_range(str);
}
