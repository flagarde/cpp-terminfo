...
public:
  ...
  Terminfo(const Type &type, const std::set<Boolean> &booleans,
           const std::map<Integer, std::uint16_t> &integers,
           const std::map<String, std::string> &strings)
      : m_type(type), m_booleans(booleans), m_integers(integers),
        m_strings(strings) {}
